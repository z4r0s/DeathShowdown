...
public class DeathCloseAttack : MonoBehaviour
{
    ...
    {
        if (other.gameObject.tag != "Unbreakable" || other.gameObject.tag != "Player")
        {
            if (other.gameObject.tag == "Hela" && GameController.instance.helaShielded != true || other.gameObject.tag == "Anubis" && GameController.instance.anubisShielded != true || other.gameObject.tag == "Hades" && GameController.instance.hadesShielded != true) 
            {
                Debug.Log("Pegou");
